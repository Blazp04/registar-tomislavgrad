...
export const createStudentSchema = z.object({
  ...
  highSchoolCityId: z.string().uuid("Grad srednje škole je obavezan"),
  ...
  facultyId: z.string().uuid("Odaberite fakultet"),
  fieldOfStudyId: z.string().uuid("Odaberite smjer"),
  facultyCityId: z.string().uuid("Odaberite grad fakulteta"),
